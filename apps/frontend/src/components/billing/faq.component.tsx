...
const useFaqList = () => {
  ...
  return [
    ...(user?.allowTrial
      ...
      : []),
    {
      title: t('faq_can_i_trust_postiz_gitroom'),
      description: t('faq_postiz_gitroom_is_proudly_open_source'),
    },
    {
      title: t('faq_what_are_channels'),
      description: t('faq_postiz_gitroom_allows_you_to_schedule_posts'),
    },
    {
      title: t('faq_what_are_team_members'),
      description: t(
